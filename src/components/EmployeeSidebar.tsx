...
const navigation = [
  ...
  },
  {
    title: "Personnel",
    items: [
      { to: "/salaries", icon: Banknote, label: "My Salaries" },
    ]
  },
  {
    title: "Communication",
...
const EmployeeSidebar = ({ children }: AppSidebarProps) => {
      ...
      <div className="flex flex-col h-screen overflow-hidden bg-background">
        <header className="h-16 flex items-center justify-between px-4 border-b border-border bg-sidebar shrink-0 z-50">
          <div className="flex items-center gap-2">
            ...
            <span className="font-black tracking-tighter text-lg">EMPLOYEE PANEL</span>
          </div>
        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden bg-background p-4 sm:p-6 pb-20 min-w-0">
          {children}
        </main>
      </div>
    );
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <main className="flex-1 overflow-y-auto overflow-x-hidden bg-background p-6 lg:p-8 min-w-0">
        <div className="mb-6 flex items-center gap-2 opacity-50">
          <Briefcase className="w-4 h-4 text-primary" />
          <span className="text-[10px] font-bold uppercase tracking-widest">Professional Employee Panel</span>
        </div>
        {children}
      </main>
    </div>
